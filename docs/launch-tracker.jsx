...
const XWING_PHASES = [
  ...
  },
  {
    ...
    tasks: [
      { text: "Lock MVP scope: 1v1, two or three ships each, move + attack only", done: false },
      { text: "Choose the stack — server-authoritative game state over websockets", done: false },
      { text: "Record games as a deterministic event log — the foundation for replays", done: false },
      { text: "Model the round: planning → activation by initiative → engagement → end", done: false },
      { text: "Design win conditions so 2.5 scenario play can slot in after the dogfight MVP", done: false },
      { text: "Build the board, maneuver dial & template movement", done: false },
      { text: "Build the data layer on xwing-data2 + the XWS squad format", done: false },
      { text: "Pull XWA community points dynamically — versioned & cached", done: false },
      { text: "Design mobile-first controls — thumb-reachable dial, drag-to-place templates", done: false },
      { text: "Implement attack/defense dice, range and damage", done: false },
      { text: "Add hidden simultaneous dial submission, then reveal", done: false },
      { text: "Get a hot-seat prototype working before networking", done: false },
    ],
  },
  {
    label: "Web Launch",
    ...
    tasks: [
      { text: "Add online play with invite codes — join a game by code or link", done: false },
      { text: "Persist game state so turns can be taken asynchronously", done: false },
      { text: "Add an account system — guest play first, then sign-in to save squads & history", done: false },
      { text: "Build the squad builder & ship roster", done: false },
      { text: "Support squad import/export via XWS (interop with YASB & Launch Bay Next)", done: false },
      { text: "Set up websocket-capable hosting", done: false },
      { text: 'Add the "fan project, not endorsed — buy the real models" disclaimer', done: false },
  ...
  },
  {
    ...
    tasks: [
      ...
      { text: 'Send "your turn" notifications so async games keep moving', done: false },
